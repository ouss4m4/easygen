      ...
      <form onSubmit={handleSubmit(onSubmit)} className="pt-4">
        <div className="grid gap-y-3 ">
          <div className="relative  grid gap-1">
            ...
            <div>{errors.name && <span className="text-xs text-red-500">{errors.name.message}</span>}</div>
          </div>
          ...
          <div className="relative  grid gap-1">
            ...
            <div>{errors.email && <span className="text-xs text-red-500">{errors.email.message}</span>}</div>
          </div>
          <div className="relative  grid gap-1">
            ...
            <div>{errors.password && <span className="text-xs text-red-500">{errors.password.message}</span>}</div>
          </div>
          ...
          <div className="relative  grid gap-1">
            ...
            <div>{errors.password2 && <span className="text-xs text-red-500">{errors.password2.message}</span>}</div>
          </div>
